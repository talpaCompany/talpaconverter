export const lang = {
    ...
    types: {
        ...
        energy : {
            ...
            kilocalorie : ["Quilo-caloria", "kCal"],
            watthour : ["Watt-Hora", "Wh"],
            kilowatthour : ["Quilowatt-Hora", "kWh"],
        ...
        angle : {
            degree : ["Grau", "º"],
            grado : ["Grado", "gon"],
            thousandangular: ["Mil Angular", "mil"],
        ...
        volume : {
            ...
            americanteaspoon : ["Colher de Chá Americana", "tsp"]
        }
    }
}