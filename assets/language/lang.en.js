export const lang = {
    head: {
        description: "Unit conversion calculator, simple and practical. Talpa Converter has many units categories that you can convert."
    },
    header: {
        brand: "Talpa App"
    },
    ...
    types: {
        ...
        angle : {
            degree : ["Degree", "º"],
            grado : ["Grado", "gon"],
            thousandangular: ["Thousand Angular", "mil"],
